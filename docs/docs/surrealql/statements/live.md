---
title: LIVE SELECT statement
url: https://surrealdb.com/docs/surrealql/statements/live
crawled_at: 2026-03-25 18:41:22
---
...
```
LIVE SELECT	[		[ VALUE ] @fields ... [ AS @alias ]		| DIFF	]	FROM @targets	[ WHERE @conditions ]	[ FETCH @fields ... ];
```
LIVESELECTVALUE@field,@fieldAS@aliasDIFFFROM@targetsWHERE@conditionsFETCH@fields ...;
## Example usage
...
```
LET $table = 'measurement';LET $location = 'Tallinn';LIVE SELECT * FROM type::table($table) WHERE location == $location;
```

---
title: DEFINE NAMESPACE statement
url: https://surrealdb.com/docs/surrealql/statements/define/namespace
crawled_at: 2026-03-25 18:42:44
---
...
```
DEFINENAMESPACEOVERWRITEIFNOTEXISTS@nameCOMMENT@string
## Example usage
...
```
-- Create a NAMESPACE if it does not already existDEFINE NAMESPACE IF NOT EXISTS example;
```
...
```
-- Create an NAMESPACE and overwrite if it already existsDEFINE NAMESPACE OVERWRITE example;
```

...
crawled_at: 2026-03-25 18:42:17
---
...
```
ALTER SYSTEM     COMPACT |    QUERY_TIMEOUT |    DROP QUERY_TIMEOUT
```
ALTER SYSTEMCOMPACTQUERY_TIMEOUT@durationDROP QUERY_TIMEOUT
...
```
ALTER SYSTEM QUERY_TIMEOUT 100ns;INFO FOR ROOT.config;
```
...
```
ALTER SYSTEM QUERY_TIMEOUT 1ms;FOR $_ IN 0..1000 {    FOR $_ IN 0..1000 {        CREATE |person:1000|;    }};-- 'The query was not executed because it exceeded the timeout: 1ms'
```

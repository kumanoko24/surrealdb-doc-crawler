...
crawled_at: 2026-03-25 18:42:15
---
...
```
ALTER SEQUENCEIFEXISTS@nameTIMEOUT@duration
## Examples
...
```
-------- Query --------{ mySeq3: 'DEFINE SEQUENCE mySeq3 BATCH 1000 START 100 TIMEOUT 0ns' },-------- Query --------'Thrown error: The query was not executed because it exceeded the timeout: 0ns'-------- Query --------100
```

...
crawled_at: 2026-03-25 18:43:03
---
...
API DEFINITION (before 2.3.0)API DEFINITION (after 2.3.0)
```
...
```
RETURN encoding::base64::decode("MjMyMw");-- b"32333233"
```
...
```
LET $some_bytes = encoding::base64::decode("omRjYm9yaGVuY29kaW5nYmlza3ByZXR0eSBuZWF0");encoding::cbor::decode($some_bytes);
```

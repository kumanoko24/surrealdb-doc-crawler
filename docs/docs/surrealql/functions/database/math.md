...
crawled_at: 2026-03-25 18:43:12
---
...
```
RETURN math::abs(-13.746189);13.746189f
```
...
```
RETURN math::acos(0.5);-- 1.0471975511965976f
```
...
```
RETURN math::acot(1);-- 0.7853981633974483f
```
...
```
RETURN math::asin(0.5);-- 0.5235987755982988f
```
...
```
RETURN math::atan(1);-- 0.7853981633974483f
```
...
```
RETURN math::ceil(13.146572);-- 14f
```
...
```
RETURN math::cos(1);-- 0.5403023058681398f
```
...
```
RETURN math::cot(1);-- 0.6420926159343308f
```
...
```
RETURN math::deg2rad(180);-- 3.141592653589793f
```
...
```
RETURN math::fixed(13.146572, 2);-- 13.15f
```
...
```
RETURN math::floor(13.746189);-- 13f 
```
...
```
RETURN math::interquartile([ 1, 40, 60, 10, 2, 901 ]);-- 51f
```
...
```
RETURN math::lerpangle(0, 180, 0.5);-- 90f
```
...
```
RETURN math::ln(10);-- 2.302585092994046f
```
...
```
RETURN math::max([ 26.164, 13.746189, 23, 16.4, 41.42 ]);-- 41.42f
```
...
```
RETURN math::mean([ 26.164, 13.746189, 23, 16.4, 41.42 ]);-- 24.146037800000002f
```
...
```
RETURN math::median([ 26.164, 13.746189, 23, 16.4, 41.42 ]);-- 23f
```
...
```
RETURN math::midhinge([ 1, 40, 60, 10, 2, 901 ]);-- 29.5f
```
...
```
RETURN math::min([ 26.164, 13.746189, 23, 16.4, 41.42 ]);-- 13.746189f
```
...
```
RETURN math::mode([ 1, 40, 60, 10, 2, 901 ]);-- 901RETURN math::mode([ 1, 40, 60, 10, 2, 901, 2 ]);-- 2
```
...
```
-- Nanmath::nearestrank([1, 40, 60, 10, 2, 901], 101);-- Also Nanmath::nearestrank([1, 40, 60, 10, 2, 901], -1);
```
...
```
RETURN math::percentile([1, 40, 60, 10, 2, 901], 50);-- 25f
```

A number for the percentile outside of the range 0 to 100 will return the output `NaN`.

```
-- Nanmath::percentile([1, 40, 60, 10, 2, 901], 101);-- Also Nanmath::percentile([1, 40, 60, 10, 2, 901], -1);
```
...
```
RETURN math::product([ 26.164, 13.746189, 23, 16.4, 41.42 ]);-- 5619119.004884841f
```
...
```
RETURN math::rad2deg(3.141592653589793);-- 180f
```
...
```
RETURN math::round(13.53124);-- 14f
```
...
```
RETURN math::sin(1);-- 0.8414709848078965f
```
...
```
RETURN math::sqrt(15);-- 3.872983346207417f
```
...
```
RETURN math::stddev([ 1, 40, 60, 10, 2, 901 ]);-- 359.37167389765153f
```
...
```
NONE ?? 0; -- Finds NONE so returns latter value: 01000 ?? 0; -- Finds 1000 so returns 1000 instead of 0
```
...
```
// Classic array filtering, removes NONE / NULL[0,NONE,10dec,10.7,NULL][? $this];// array::map() function, turns NONE / NULL to 0[0, NONE, 10dec, 10.7, NULL].map(|$num| $num ?? 0);
```

With this mapping in place, `math::sum()` will be guaranteed to work.

```
// Classic array filteringmath::sum([0,NONE,10dec,10.7,NULL][? $this]);// array::map() functionmath::sum([0, NONE, 10dec, 10.7, NULL].map(|$num| $num ?? 0));-- 20.7dec
```
...
```
RETURN math::tan(1);-- 1.557407724654902f
```
...
```
RETURN math::trimean([ 1, 40, 60, 10, 2, 901 ]);-- 27.25f
```

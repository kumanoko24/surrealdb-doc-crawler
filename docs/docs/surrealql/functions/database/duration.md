...
crawled_at: 2026-03-25 18:43:02
---
...
```
duration::max;duration::max + 1ns;100y IN 0ns..duration::max
```

Output

```
-------- Query 1 --------584942417355y3w5d7h15s999ms999µs999ns-------- Query 2 --------'Failed to compute: "584942417355y3w5d7h15s999ms999µs999ns + 1ns", as the operation results in an arithmetic overflow.'-------- Query 3 --------true
```
...
```
RETURN duration::micros(3w);-- 1814400000000
```
...
```
RETURN duration::millis(3w);-- 1814400000
```
...
```
RETURN duration::nanos(3w);-- 1814400000000000
```
...
```
RETURN duration::secs(3w);-- 1814400
```
...
```
RETURN duration::from_days(3);-- 3d
```
...
```
RETURN duration::from_hours(3);-- 3h
```
...
```
RETURN duration::from_micros(3);-- 3μs
```
...
```
RETURN duration::from_millis(3);-- 3ms
```
...
```
RETURN duration::from_mins(3);-- 3m
```
...
```
RETURN duration::from_nanos(3);-- 3ns
```
...
```
RETURN duration::from_secs(3);-- 3s
```
...
```
RETURN duration::from_weeks(3);-- 3w
```
...
```
-- Traditional syntaxduration::mins(2d6h);-- Method chaining syntax2d6h.mins();
```
...
```
-- Traditional syntaxduration::mins(duration::from_millis(98734234));-- Method chaining syntaxduration::from_millis(98734234).mins();
```

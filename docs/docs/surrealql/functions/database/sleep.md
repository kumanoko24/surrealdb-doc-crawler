...
url: https://surrealdb.com/docs/surrealql/functions/database/sleep
crawled_at: 2026-03-25 18:43:28
---
...
```
-- Create 3 `person` recordsCREATE |person:3|;LET $now = time::now();SELECT *,   sleep(100ms) AS _,   time::now() - $now AS elapsedFROM person;
```

---
title: FROM clause
url: https://surrealdb.com/docs/surrealql/clauses/from
crawled_at: 2026-03-25 18:41:48
---
...
```
-- Select only the 'user' table.SELECT * FROM ONLY user:one;-- Selects only the first 10 records from the 'user' table.SELECT * FROM ONLY user LIMIT 10;
```

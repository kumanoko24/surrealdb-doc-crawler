...
url: https://surrealdb.com/docs/surrealql/clauses/group-by
crawled_at: 2026-03-25 18:41:50
---
...
```
SELECT    product_id,    region,    math::sum(amount) AS total_salesFROM    salesGROUP BY    product_id, region;
```

---
title: Geometries
url: https://surrealdb.com/docs/surrealql/datamodel/geometries
crawled_at: 2026-03-25 18:40:31
---
...
```
-- true: has `type` and `coordinates` field with valid data{ type: "Point", coordinates: [-0.118092, 51.509865] }.is_geometry();-- false: lacks 'type' field{ coordinates: [-0.118092, 51.509865] }.is_geometry();-- false: has an extra field{ type: "Point", coordinates: [-0.118092, 51.509865], unnecessary: "data" }.is_geometry();
```
...
```
CREATE city:london SET centre = {    type: "Point",    coordinates: [-0.118092, 51.509865],};
```
...
```
CREATE city:london SET distance = {    type: "LineString",    coordinates: [[-0.118092, 51.509865],[0.1785278, 51.37692386]],};
```
...
```
CREATE city:london SET boundary = {	type: "Polygon",	coordinates: [[		[-0.38314819, 51.37692386], [0.1785278, 51.37692386],		[0.1785278, 51.61460570], [-0.38314819, 51.61460570],		[-0.38314819, 51.37692386]	]]};
```
...
```
CREATE person:tobie SET locations = {	type: "MultiPoint",	coordinates: [		[10.0, 11.2],		[10.5, 11.9]	],};
```
...
```
CREATE travel:yellowstone SET routes = {	type: "MultiLineString",	coordinates: [		[ [10.0, 11.2], [10.5, 11.9] ],		[ [11.0, 12.2], [11.5, 12.9], [12.0, 13.0] ]	]}
```
...
```
CREATE university:oxford SET locations = {	type: "MultiPolygon",	coordinates: [		[			[ [10.0, 11.2], [10.5, 11.9], [10.8, 12.0], [10.0, 11.2] ]		],		[			[ [9.0, 11.2], [10.5, 11.9], [10.3, 13.0], [9.0, 11.2] ]		]	]};
```

...
crawled_at: 2026-03-25 18:40:25
---
...
```
DEFINE FIELD time ON event TYPE datetime;CREATE event SET time = "2025-07-03T07:18:52.841147";
```
...
```
DEFINE FIELD time ON event TYPE datetime;CREATE event SET time = d"2025-07-03T07:18:52.84114Z";
```

Response

```
[    {         id: event:w2lhv58f7c9z7xo4nqkq,         time: d'2025-07-03T07:18:52.841140Z'     }]
```
...
```
d'1970-01-01T00:00:00.000000100Z'.set_year(1914);-- Outputd'1914-01-01T00:00:00.000000100Z'
```

As these functions do not modify an existing datetime but return a new one, they can be chained one after another.

```
d'1970-01-01T00:00:00.000000100Z'    .set_year(1914)    .set_month(6)    .set_day(28);-- Outputd'1914-06-28T00:00:00.000000100Z'
```
